...
6. If you did everything correct, https://heckramirezc.github.io/mcv2_cenam_api/ will lead to your new docs
...
- Documentation(ReDoc): https://heckramirezc.github.io/mcv2_cenam_api/
- SwaggerUI: https://heckramirezc.github.io/mcv2_cenam_api/swagger-ui/
- Look full spec:
    + JSON https://heckramirezc.github.io/mcv2_cenam_api/swagger.json
    + YAML https://heckramirezc.github.io/mcv2_cenam_api/swagger.yaml
- Preview spec version for branch `[branch]`: https://heckramirezc.github.io/mcv2_cenam_api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://heckramirezc.github.io/mcv2_cenam_api/ with url from the message: `Server started <url>`
